...
basis_method_LGL_Only=1;%----------------------------Make sure it is 1!
form_method='strong';
xmin=-1;
xmax=+1;
...
if (iplot_movie == 1)
    ...
    for i=1:iframe
        ...
        title_text=['Ne = ' num2str(nelem) ', NLGL = ' num2str(nop_LGL) ', NLGR = ' num2str(nop_LGR) ', Time = ' num2str(time_movie(i))];
...
if (iplot_figures)
    ...
    axis([xmin xmax hmin hmax]);
    title_text=[' Ne = ' num2str(nelem) ', NLGL = ' num2str(nop_LGL) ', NLGR = ' num2str(nop_LGR) ', Time = ' num2str(time)];
    title([title_text],'FontSize',18);
    hold on;
...
if (iplot_u_max==1)
    ...
    axis([xmin xmax hmin hmax]);
    title_text=[' Ne = ' num2str(nelem) ', NLGL = ' num2str(nop_LGL) ', NLGR = ' num2str(nop_LGR)];
    title([title_text],'FontSize',18);
    hold on;
