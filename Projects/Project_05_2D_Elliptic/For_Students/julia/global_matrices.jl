...
function global_matrices(ψ,dψ,ξ_x,ξ_y,η_x,η_y,jac,ωq,intma,Ne,Np,Nq,Npoin,DFloat)

    if (Np==Nq)
        (M,L) = global_matrices_inexact(ψ,dψ,ξ_x,ξ_y,η_x,η_y,jac,ωq,intma,Ne,Np,Nq,Npoin,DFloat)
    elseif (Np!=Nq)
        (M,L) = global_matrices_exact(ψ,dψ,ξ_x,ξ_y,η_x,η_y,jac,ωq,intma,Ne,Np,Nq,Npoin,DFloat)
    end
    return (M,L)
