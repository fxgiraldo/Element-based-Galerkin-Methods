...
disp(['row sum psi = ',num2str(row_sum_psi),' row_sum_dpsi = ',num2str(row_sum_dpsi)])
...
dt=Courant_max*dx/u;
Courant=u*dt/dx;
disp(['Courant = ',num2str(Courant),' dt = ',num2str(dt),' time_final = ',num2str(time_final)])
...
%De = create_diff_matrix(ngl,nq,wnq,psi,dpsi); %Weak Form Dw
...
%Time Integration
[q0,time] = ti_LSRK(q0,Dmatrix_hat,periodicity,time,time_final,dt);
