...
Courant_max=2; %This is what controls the time-step
...
%------------------Allowed to CHANGE-------------------%
%Defines Test Case
time_final=10; %final time in revolutions: use =1 for NFBC and =10 for NRBC
delta_nl=0; %=0 linear and =1 nonlinear
icase=0; %=0 is a Gaussian exp(-16r^2) Advection as used in many other sample problems in Giraldo 2020 book
...
experiment_method=3; %1=LGL with NFBC
...
%Create Grid
[coord,coord_cg,intma,jac,wnq,npoin,xmin_grid,xmax_grid] = create_grid(ngl,ngl_LGR,nelem,nelem_LGL,xgl,xgr,wgl,wgr,icase,LGR_basis,LGR_scale,LGR_scale_factor,LGR_artificial_layer,lsponge);
