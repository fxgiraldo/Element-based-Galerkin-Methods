...
function main()
    ...
    #-----------------------------Students Add their Functions inside ti_LSRK--------------------------#
    (q0,time) = ti_LSRK!(q0,ue,coord,M,ψ,dψ,ξ_x,ξ_y,η_x,η_y,jac,jac_face,ωq,intma,periodicity,face,mapL,mapR,normals,time,time_final,c,ntime,dt,space_method,plot_movie,Nx,Ny,coord_CG,periodicity_CG,DG_to_CG,DFloat)
    #-----------------------------Students Add their Functions inside ti_LSRK--------------------------#
    #-----------------------------Students Add their Functions inside ti_LSRK--------------------------#
