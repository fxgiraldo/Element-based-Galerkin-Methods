...
for is=1:nside
    ...
    for l=1:nq
        ...
        [ql_k, ql_x, ql_y] = compute_flux_SIP_qterms(ql,psi,dpsi,ngl,nq,...
                             ksi_x,ksi_y,eta_x,eta_y,ilocl,el,l);                  
        
        %Interpolate Right-State onto Quadrature Points
        if (er > 0)
            [qr_k, qr_x, qr_y] = compute_flux_SIP_qterms(qr,psi,dpsi,ngl,nq,...
        ...
        for i=1:ngl
          ...
          %Left States
          h_i=psi(i,l);          
          [psil_x, psil_y] = compute_flux_SIP_basis(psi,dpsi,ngl,nq,...
          ...
          flux_psir=flux_psil;
          if (er > 0)
             [psir_x, psir_y] = compute_flux_SIP_basis(psi,dpsi,ngl,nq,...
