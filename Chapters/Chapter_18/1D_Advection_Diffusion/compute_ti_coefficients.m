...
elseif kstages == 5 %Kinmark and Gray Non-SSP
    a0(1)=1; a1(1)=0; beta(1)=1.0/5.0;
    a0(2)=1; a1(2)=0; beta(2)=1.0/5.0;
    a0(3)=1; a1(3)=0; beta(3)=1.0/3.0;
    a0(4)=1; a1(4)=0; beta(4)=2.0/3.0;
    a0(5)=-1.0/4.0; a1(5)=5.0/4.0; beta(5)=3.0/4.0;
end