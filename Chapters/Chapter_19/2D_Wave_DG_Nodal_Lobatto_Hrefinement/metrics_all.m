...
%---------------------------------------------------------------------%
function [ksi_x,ksi_y,eta_x,eta_y,jac] = metrics_all(coord,intma,psi,dpsi,wnq,nelem,ngl,nq)

%Initialize Global Arrays
ksi_x=zeros(5*nelem,nq,nq);
ksi_y=zeros(5*nelem,nq,nq);
eta_x=zeros(5*nelem,nq,nq);
eta_y=zeros(5*nelem,nq,nq);
jac=zeros(5*nelem,nq,nq);
