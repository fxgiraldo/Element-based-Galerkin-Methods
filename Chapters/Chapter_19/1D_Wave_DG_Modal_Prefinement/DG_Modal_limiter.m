...
% [L,dL] = legendre_basis_modal(ngl,nq,xnq);
...
for itime=1:ntime
   ...
   for ik=1:kstages
      ...
      %Create RHS Matrix
      rhs = create_diff_and_flux_dg_modal(qp,nelem,nq,wnq,L,Ls,dL,u,diss,dx,element_order);
      ...
      for e=1:nelem
         ...
         rhs_inv=mass_t*rhs_t;
         qp(1:N,e)=a0*q0(1:N,e) + a1*q1(1:N,e) + dtt*rhs_inv(1:N);
      end %e
...
%    end
    ...
    %P-Adaptivity
    if adapt == 1
        [qp,element_order] = change_polynomial_order_v2(qp,nelem,element_order,p_tol,p_tol2,nop_min,nop_max);
    end %if
